...
namespace Connect_four
{
    internal class Shogi_Board
    {
        ...
        public Shogi_Board(List<Texture2D> textures)
        {
            ...
            _pieces[5, 8] = new ShogiPiece(textures[9], textures[10], 4, 1);//Gold
            _pieces[3, 8] = new ShogiPiece(textures[9], textures[10], 4, 1);
            _pieces[3, 0] = new ShogiPiece(textures[9], textures[10], 4, 2);
            _pieces[5, 0] = new ShogiPiece(textures[9], textures[10], 4, 2);//Gold
            

            _pieces[4, 8] = new ShogiPiece(textures[15], textures[16], 4, 1);//King
            _pieces[4, 0] = new ShogiPiece(textures[15], textures[16], 4, 2);//King
